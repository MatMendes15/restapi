...
public class DisciplinaController {
    ...
    public DisciplinaController() {
        ...
        disciplinas.add(new Disciplina(1, "Programação de Sistemas 2", "P.D.S2", "Sistemas de informação", 3));
        disciplinas.add(new Disciplina(2, "Estrutura de dados", "E.D.D2", "Sistemas de informação", 3));
        disciplinas.add(new Disciplina(3, "Calculo 1", "Calc1", "Ciência da computação", 2));
        disciplinas.add(new Disciplina(1, "Redes e computadores", "R.C", "Sistemas de informação", 4));
        disciplinas.add(new Disciplina(2, "Circuitos elétricos", "C.E", "Ciência da computação", 5));
        disciplinas.add(new Disciplina(3, "Game Design", "G.D", "Análise e desenvolvimento de sistemas", 6));
    }
